...
public class CountryUtils {
    ...
    int getFlagDrawableResId(Country country) {
        switch (country.getRegionCode().toLowerCase()) {
    ...
    public static List<Country> getFilteredCountries(String query,List<Country> masterList) {
...
//            }
        ...
        for (Country country : masterList) {
